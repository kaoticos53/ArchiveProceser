...
public partial class ScriptStudioWindow : Window
{
    ...
    public string SelectedLanguage => _viewModel?.SelectedLanguage ?? "CSharp";
    public string ScriptCode => _viewModel?.ScriptCode ?? string.Empty;
    public string InputPortsString => _viewModel != null ? string.Join(", ", _viewModel.InputPorts) : "In";
    public string OutputPortsString => _viewModel != null ? string.Join(", ", _viewModel.OutputPorts) : "Out";

    public ScriptStudioWindow() : this("CSharp", string.Empty, "In", "Out")
    {
    }
