...
| 📖 [**Manual de Usuario y Operación**](user_guide.md) | Guía paso a paso de la interfaz visual, catálogo de los 57 nodos oficiales, controles de depuración (Breakpoints y Silenciado de Logs `≡`), consola de telemetría con trazabilidad por archivo y FAQ. | Usuarios Finales & Administradores |
