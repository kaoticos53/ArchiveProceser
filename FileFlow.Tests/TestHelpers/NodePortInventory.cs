...
public static class NodePortInventory
{
    ...
    [
        ...
        new("FileForkNode", "Version", Coverage.ByExecutingTest,
            "FileForkNode_EmitsParallelBranchesForOriginalAndCurrent"),
        new("ForkJoinBarrierNode", "AllCompleted", Coverage.ByNamedTest,
            "TheBarrier_ShouldReleaseTheItemOnceEveryBranchReports"),
        new("ForkJoinBarrierNode", "Fork1", Coverage.ByNamedTest,
            "TheBarrier_ShouldReleaseTheItemOnceEveryBranchReports"),
        new("ForkJoinBarrierNode", "Fork2", Coverage.ByNamedTest,
            "TheBarrier_ShouldReleaseTheItemOnceEveryBranchReports"),
